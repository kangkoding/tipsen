...
<head>
    ...
    <title>TIPSEN | @yield('title')</title>
    <!-- plugins:css -->
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="kelas">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ base_url() }}classroom">Semua Data</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#matapelajaran" aria-expanded="false" aria-controls="matapelajaran">
                            <span class="menu-title">Mata Pelajaran</span>
                            <i class="menu-arrow"></i>
                            <i class="mdi mdi-book menu-icon"></i>
                        </a>
                        <div class="collapse" id="matapelajaran">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="#">Semua Data</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#">Tambah Data</a>
                                </li>
                ...
                <footer class="footer">
                    <div class="
                        ...
                        <span class="
								...
								">Copyright © 2021
                            <a href="#">KANGKODING</a>. All rights reserved.</span>
                    </div>
                </footer>
                <!-- partial -->
            </div>
